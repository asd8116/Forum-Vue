  ...
  <div class="col-md-6 col-lg-4">
    <div class="card mb-4">
      ...
      <div class="card-footer">
        ...
        >移除最愛</button>
        <button v-else type="button" class="btn btn-primary btn-border favorite mr-2" @click.stop.prevent="addFavorite(restaurant.id)">加到最愛</button>

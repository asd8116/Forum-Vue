      ...
      <div class="row no-gutters">
        ...
        <div class="col-md-8">
          <div class="card-body">
            ...
            <button v-if="restaurant.isFavorited" type="button" class="btn btn-danger mr-2" @click.stop.prevent="removeFavorite(restaurant.id)">移除最愛</button>
...
const dummyData = {
  restaurants: [
    ...
    },
    {
      ...
      image: 'https://loremflickr.com/320/240/food,dessert,restaurant/?random=23',
      createdAt: '2019-06-22T09:00:43.000Z',
      updatedAt: '2019-06-22T09:00:43.000Z',
      CategoryId: 3,
      FavoritedUsers: [],
    ...
    },
    {
      ...
      image: 'https://loremflickr.com/320/240/food,dessert,restaurant/?random=24',
      createdAt: '2019-06-22T09:00:43.000Z',
      updatedAt: '2019-06-22T09:00:43.000Z',
      CategoryId: 3,
      FavoritedUsers: [],
    ...
    },
    {
      ...
      image: 'https://loremflickr.com/320/240/food,dessert,restaurant/?random=25',
      createdAt: '2019-06-22T09:00:43.000Z',
      updatedAt: '2019-06-22T09:00:43.000Z',
      CategoryId: 2,
      FavoritedUsers: [],
    ...
    },
    {
      ...
      image: 'https://loremflickr.com/320/240/food,dessert,restaurant/?random=22',
      createdAt: '2019-06-22T09:00:43.000Z',
      updatedAt: '2019-06-22T09:00:43.000Z',
      CategoryId: 3,
      FavoritedUsers: [],
    ...
    },
    {
      ...
      image: 'https://loremflickr.com/320/240/food,dessert,restaurant/?random=27',
      createdAt: '2019-06-22T09:00:43.000Z',
      updatedAt: '2019-06-22T09:00:43.000Z',
      CategoryId: 4,
      FavoritedUsers: [],
    ...
    },
    {
      ...
      image: 'https://loremflickr.com/320/240/food,dessert,restaurant/?random=28',
      createdAt: '2019-06-22T09:00:43.000Z',
      updatedAt: '2019-06-22T09:00:43.000Z',
      CategoryId: 3,
      FavoritedUsers: [],
    ...
    },
    {
      ...
      opening_hours: '08:00',
      description: 'dolor',
      image: 'https://loremflickr.com/320/240/food,dessert,restaurant/?random=29',
      createdAt: '2019-06-22T09:00:43.000Z',
      updatedAt: '2019-06-22T09:00:43.000Z',
      CategoryId: 3,
      FavoritedUsers: [],
    ...
    },
    {
      ...
      image: 'https://loremflickr.com/320/240/food,dessert,restaurant/?random=30',
      createdAt: '2019-06-22T09:00:43.000Z',
      updatedAt: '2019-06-22T09:00:43.000Z',
      CategoryId: 4,
      FavoritedUsers: [],
    ...
    },
    {
      ...
      image: 'https://loremflickr.com/320/240/food,dessert,restaurant/?random=31',
      createdAt: '2019-06-22T09:00:43.000Z',
      updatedAt: '2019-06-22T09:00:43.000Z',
      CategoryId: 2,
      FavoritedUsers: [],
